...
> **AppKit rebuild:** The native migration specification, LaunchOS visual
> reference, performance contract, and staged rollout plan are documented in
> [`docs/appkit-rebuild-spec.md`](docs/appkit-rebuild-spec.md) and
